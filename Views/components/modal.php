    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="uploadForm" class="dropzone" action="<?php echo BASE_URL . 'recursos/subirarchivo'; ?>">
                <input type="hidden" id="id_carpeta" name="id_carpeta">
                </form>
            </div>
            <div class="modal-footer">
                <button class="btn btn-outline-danger" type="button" id="btnCancelarLimpiar">Cancelar</button>
                <button class="btn btn-outline-primary" type="button" id="btnProcesar">Añadir</button>
            </div>
        </div>
    </div>
</div>
...
<div id="modalCompartir" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="d-grid">
                    <a href="#" id="btnVer" class="btn btn-outline-info m-r-xs"><i class="material-icons">folder_zip</i>Ver archivos</a>
                    <hr>
