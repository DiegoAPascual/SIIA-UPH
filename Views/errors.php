...
<div class="app app-error align-content-stretch d-flex flex-wrap">
    <div class="app-error-info">
        <h5>Error 404!</h5>
        <span>¡Lo sentimos, la página que buscas no puede ser encontrada!
            <br><br>
            - Por favor, verifica la URL e inténtalo de nuevo.
            <br>
            - Si deseas volver al inicio, simplemente haz clic en el botón.
        </span>
        <a href="<?php echo BASE_URL . 'admin'; ?>" class="btn btn-dark">Ir a inicio</a>
    </div>
