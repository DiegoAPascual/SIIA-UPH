                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" id="correo" name="correo" placeholder="correo@gmail.com" value="<?php echo  $data['usuario']['correo']; ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="telefono" class="form-label">Teléfono*:</label>
                                        <input type="number" class="form-control" id="telefono" name="telefono" placeholder="Ingrese su número de teléfono" value="<?php echo  $data['usuario']['telefono']; ?>">
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col-md-6">
                                        <label for="nombre" class="form-label">Nombre(s)*:</label>
                                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese su nombre" value="<?php echo  $data['usuario']['nombre']; ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="apellido" class="form-label">Apellidos*:</label>
                                        <input type="text" class="form-control" id="apellido" name="apellido" placeholder="Ingrese sus apellidos" value="<?php echo  $data['usuario']['apellido']; ?>">
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col">
                                        <label for="direccion" class="form-label">Direccción:</label>
                                        <textarea class="form-control" id="direccion" name="direccion" placeholder="Ingrese su dirección completa" maxlength="500" rows="4"><?php echo  $data['usuario']['direccion']; ?></textarea>
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row m-t-xxl">
                                    <div class="col-md-6">
                                        ...
                                        <input type="password" id="clave_nueva" name="clave_nueva" class="form-control" placeholder="Ingrese su nueva contraseña">
                                    </div>
                                </div>
                                <div class="row m-t-xxl">
                                    <div class="col-md-6">
                                        <label for="settingsConfirmPassword" class="form-label">Confirmar contraseña</label>
                                        <input type="password" id="clave_confirmar" name="clave_confirmar" class="form-control" placeholder="Confirme su nueva contraseña">
                                    </div>
                                </div>
                                <div class="row m-t-lg">
                                    <div class="col">
