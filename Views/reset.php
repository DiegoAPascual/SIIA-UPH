        ...
        <div class="app-auth-container">
            ...
            <form id="formRestablecer" autocomplete="off">
                ...
                <div class="auth-credentials m-b-xxl">
                    ...
                    <input type="password" class="form-control m-b-md" id="clave_nueva" name="clave_nueva" placeholder="Ingrese una contraseña nueva">

                    <label for="clave" class="form-label">Confirmar contraseña <span class="text-danger">*</span></label>
                    <input type="password" class="form-control" id="clave_confirmar" name="clave_confirmar" placeholder="Confirme su contraseña">
                </div>
