  ...
  http.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      <div class="mailbox-open-author">
          <img src="${base_url + 'Assets/images/6073873.png'}" alt="">
          <div class="mailbox-open-author-info">
              <span class="mailbox-open-author-info-email d-block">${res.compartido}</span>
              <span class="mailbox-open-author-info-to">De <span class="badge badge-info align-self-center">${res.usuario} ${res.apellido}</span></span>
          </div>
          <div class="mailbox-open-actions">
              <a href="#" class="btn btn-danger" onclick="eliminarCompartido(${res.id})">Eliminar compartido</a>
          </div>
      </div>
...
function eliminarCompartido(id){
    ...
    eliminarRegistro("¿ESTÁS SEGURO DE ELIMINAR?", "El archivo compartido desaparecerá de tu lista.", "Si, eliminar", url, null)
}
